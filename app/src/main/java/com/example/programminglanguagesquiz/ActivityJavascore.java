...
public class ActivityJavascore extends AppCompatActivity {
    TextView text;
    TextView b1, b2,b3 ,main;
    private static final String DATA1 = "Score J-R1";
    private static final String DATA2 = "Score J-R2";
    private static final String DATA3 = "Score J-R3";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_javascore);
        ...
        noteRef1.get()
                .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        if(documentSnapshot.exists()){
                            ...
                            Toast.makeText(ActivityJavascore.this,"Document does not exists",Toast.LENGTH_SHORT).show();
                        }
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(ActivityJavascore.this,"Error!",Toast.LENGTH_SHORT).show();
                        Log.d(String.valueOf(ActivityJavascore.this),e.toString());
                    }
                });
