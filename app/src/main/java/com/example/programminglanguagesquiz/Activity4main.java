                            ...
                            public void onSuccess(DocumentSnapshot documentSnapshot) {
                                ...
                                if (documentSnapshot.exists()) {
                                    ...
                                    if(documentSnapshot.getString("StatusJ1") != null && documentSnapshot.getString("StatusJ2") != null){
                                        openActivity4main3();
                                    } else if(documentSnapshot.getString("StatusJ1")!= null){
                                        openActivity4main2();
                                    }
                                } else {
                                    Toast.makeText(Activity4main.this, "Document does not exist.", Toast.LENGTH_SHORT).show();
                                }
                                Toast.makeText( Activity4main.this, "Checked successfully", Toast.LENGTH_SHORT).show();
                            }
                        })
