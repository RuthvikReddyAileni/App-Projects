...
public class Activity43 extends AppCompatActivity {
    ...
    private static final  String TAG = "Activity43";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i = 0;i<15;i++) {
            ...
            line = "Q" + line;
            DocumentReference noteRef1 = db.collection("QuestionsJ3").document(line);
            noteRef1.get()
                    .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                        ...
                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                            if (documentSnapshot.exists()) {
                                ...
                                Toast.makeText(Activity43.this, "Document does not exists", Toast.LENGTH_SHORT).show();
                            }
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(Activity43.this, "Error!", Toast.LENGTH_SHORT).show();
        ...
        for(int j = 0;j<15;j++){
            ...
            String line = Integer.toString(y);
            line = "Q"+line;
            DocumentReference noteRef1 = db.collection("AnswersJ3").document(line);
            noteRef1.get()
                    .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                        @Override
                        public void onSuccess(DocumentSnapshot documentSnapshot) {
        ...
        button1 =  findViewById(R.id.startjava3);
        ...
        button2 =  findViewById(R.id.main5);
