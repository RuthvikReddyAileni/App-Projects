...
public class Activity42 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i = 0;i<15;i++) {
            ...
            line = "Q" + line;
            DocumentReference noteRef1 = db.collection("QuestionsJ2").document(line);
            noteRef1.get()
                    .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                        ...
                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                            if (documentSnapshot.exists()) {
                                ...
                                Toast.makeText(Activity42.this, "Document does not exists", Toast.LENGTH_SHORT).show();
                            }
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(Activity42.this, "Error!", Toast.LENGTH_SHORT).show();
        ...
        for(int j = 0;j<15;j++){
            ...
            String line = Integer.toString(y);
            line = "Q"+line;
            DocumentReference noteRef1 = db.collection("AnswersJ2").document(line);
            noteRef1.get()
                    .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                        @Override
                        public void onSuccess(DocumentSnapshot documentSnapshot) {
        ...
        button1 =  findViewById(R.id.startjava2);
        ...
        button2 =  findViewById(R.id.main4);
