...
public class Activity421 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(i==4){
            Activity42.questions[4] = "Which of these keywords is used to prevent content of a variable from being modified ?";
        } if(i==14){
            Activity42.questions[14] = "Which of the following has the highest memory requirement?";
        }

        if(i!=15) {
            question.setText(Activity42.questions[i]);
            op1.setText(Activity42.options[i][0]);
            op2.setText(Activity42.options[i][1]);
            op3.setText(Activity42.options[i][2]);
            op4.setText(Activity42.options[i][3]);
            key = Activity42.key[i];
        }
        else {

            Map<String, Object> data1 = new HashMap<>();
            data1.put("Score J-R2",MainActivity.score);
            ...
            db.collection("Mobile Quiz").document(userID)
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Log.d("Activity421", "DocumentSnapshot successfully written!");
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Log.w("Activity421", "Error writing document", e);
                        }
                    });

            if(MainActivity.score < 10)
            {
                Toast.makeText(Activity421.this, "You didn't qualify for round 2 as you scored less than 10.", Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(Activity421.this, "Congratulations , you are qualified to round 3 by scoring  "+ MainActivity.score +" .", Toast.LENGTH_LONG).show();
    ...
    public void onBackPressed () {
        Toast.makeText(Activity421.this,"You can't go to previous screen . You can quit the test if you want to .",Toast.LENGTH_SHORT).show();
